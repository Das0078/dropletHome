...
export function VortexDemo() {
  ...
  Request a demo
        ...
        <p onClick={()=>window.location.href="https://droplet-fe.onrender.com"} className="px-2 py-2 cursor-pointer text-white text-[2rem] backdrop-blur-sm border bg-cyan-300/10 border-cyan-500/20 text-center rounded-full relative mt-2">
          Request a demo →
        </p>
      </Vortex>
    </div>
